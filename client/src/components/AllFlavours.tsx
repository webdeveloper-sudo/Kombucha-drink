    ...
    <div className="flex flex-col items-center relative z-10">
          ...
          <button
            ...
            className={`rounded-full px-6 py-2 text-sm uppercase tracking-wider font-medium transition-all duration-300 ${
              selectedCategory === cat
                ? "bg-light-gray text-gray-800 shadow-lg scale-105"
                : "bg-white text-gray-800 border border-light-gray/20 hover:border-light-gray/50"
            }`}
          >
            {cat}
          </button>
      ...
      <div className="relative w-full container mx-auto  flex items-center justify-center  px-2 md:px-8">
        ...
        <div className="w-full overflow-hidden flex justify-center px-4 md:px-12">
          ...
          <div className="py-20 text-gray-800/60 uppercase font-medium tracking-widest text-sm">
