...
const Showcase = () => {
  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center justify-center bg-cream overflow-hidden py-20 px-6">
        ...
        <div className="w-full flex flex-col gap-4 mt-8">
          {links.map((link, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className={`group relative flex items-center justify-between p-5 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(27,77,62,0.08)] transition-all duration-300 w-full overflow-hidden`}
            >
              {/* Hover Gradient Effect */}
              <div className={`absolute inset-0 bg-gradient-to-r ${link.gradient} translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ease-in-out`} />
