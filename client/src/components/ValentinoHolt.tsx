...
const ValentinoHolt = () => {
  return (
    <section className="py-20 bg-cream relative overflow-hidden" id="valentino-presentation">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#E6E6E6]/10 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4 pointer-events-none" />
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 w-full">
        ...
        <div className="w-full  mx-auto">
          ...
          {/* Letter Box */}
          <div className="w-full bg-white rounded-md p-6 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-200 relative overflow-hidden block">
